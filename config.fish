...
abbr c      'claude --debug --verbose --dangerously-skip-permissions --effort max'
abbr cr     'claude --debug --verbose --dangerously-skip-permissions --effort max --resume'
abbr dc     'docker-compose'
abbr dcb    'docker-compose build'
abbr dcr    'docker-compose run'
abbr dcu    'docker-compose up'
abbr fr     'fd --changed-within 1d'
abbr ga     'git add'
abbr gb     'git branch'
...
abbr yt     'yt-dlp --output "%(channel,uploader)s/%(release_date>%Y-%m-%d,upload_date>%Y-%m-%d)s %(title).100s/%(title).100s-%(id)s.%(ext)s" --compat-options filename,format-spec,multistreams --console-title --verbose --all-subs --write-comments --write-description --write-info-json --write-link --write-thumbnail'
