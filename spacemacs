...
you should place your code here."
  ...
  (global-set-key (kbd "H-1") 'spacemacs/persp-switch-to-1)
  (global-set-key (kbd "H-2") 'spacemacs/persp-switch-to-2)
  (global-set-key (kbd "H-3") 'spacemacs/persp-switch-to-3)
  (global-set-key (kbd "H-4") 'spacemacs/persp-switch-to-4)
  (global-set-key (kbd "H-5") 'spacemacs/persp-switch-to-5)
  (global-set-key (kbd "H-6") 'spacemacs/persp-switch-to-6)
  (global-set-key (kbd "H-7") 'spacemacs/persp-switch-to-7)
  (global-set-key (kbd "H-8") 'spacemacs/persp-switch-to-8)
  (global-set-key (kbd "H-9") 'spacemacs/persp-switch-to-9)
  (global-set-key (kbd "H-0") 'spacemacs/persp-switch-to-0)
  (global-set-key (kbd "H-n") 'spacemacs/helm-persp-switch-project)
  ...
  (with-eval-after-load 'neotree
    ...
    (evil-define-key 'evilified neotree-mode-map (kbd "C-w C-l") 'evil-window-right)
    (evil-define-key 'evilified neotree-mode-map (kbd "P") 'neotree-select-up-node)
